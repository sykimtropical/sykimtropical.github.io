...
![테스트코드 생성 단축키](https://sykimtropical.github.io/img/testcode-create-shortcut.png)


<br>
이후 나오는 팝업에서 클래스명, 패키지, 생성하고자 하는 매서드를 선택하여 OK

![테스트코드 생성 팝업](https://sykimtropical.github.io/img/testcode-create-popup.png)


<br>
이후 test패키지 내에 생성된 테스트코드 확인 가능

![생성된 테스트코드 패키지](https://sykimtropical.github.io/img/created-test-code-package.png)
